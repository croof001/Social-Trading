...
class KeywordsControllerTest < ActionController::TestCase
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post :create, keyword: { client_id: @keyword.client_id, phrase: @keyword.phrase, priority: @keyword.priority }
    end
  ...
  test "should update keyword" do
    patch :update, id: @keyword, keyword: { client_id: @keyword.client_id, phrase: @keyword.phrase, priority: @keyword.priority }
    assert_redirected_to keyword_path(assigns(:keyword))
  end
